...
class InvestmentsViewModel @Inject constructor(
    ...
    val uiState: StateFlow<InvestmentsUiState> = combine(
    ...
    ) { investments, cashSettings, totalIncome, totalExpense ->
        ...
        InvestmentsUiState(investments, totalValue, totalCost, gainLoss, gainLossPct, typeBreakdown, cashAvailable, initialCash)
